namespace PreciseTriggerBf
{
    ...
    BFEvaluationResponse @OnEvaluate(SimulationManager @simManager, const BFEvaluationInfo &in info)
    {
        ...
        bool inTrigger = raceTime >= triggerCheckMinTime && targetTrigger.ContainsPoint(simManager.Dyna.CurrentState.Location.Position);
    ...
    void OnSimulationBegin(SimulationManager @simManager)
    {
        ...
        triggerCheckMinTime = GetInputModLeastMinTime();
        if (triggerCheckMinTime >= 1000000000)
            triggerCheckMinTime = 0;
