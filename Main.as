...
void RegisterCommonRoutes()
{
    ...
    RegisterRoute("GET", "/api/bf/initial-run", HandleGetInitialRun);
    RegisterRoute("GET", "/api/bf/initial-run-meta", HandleGetInitialRunMeta);
    RegisterRoute("GET", "/viewer/single", HandleViewerSingle);
}
...
void Main()
{
    ...
    RegisterVariable("bf_random_seed", -1);
    ...
    RegisterVariable("bf_scripting_playground_script", "car.speed");
    RegisterVariable("bf_scripting_playground_script_height", 80);
    ...
    RegisterVariable("bf_input_mod_chance", 100);
    ...
    RegisterVariable("bf_insert_steer_mode", "range");
    RegisterVariable("bf_insert_steer_min", -65536);
    RegisterVariable("bf_insert_steer_max", 65536);
    RegisterVariable("bf_insert_steer_add_diff", 0);
    RegisterVariable("bf_insert_steer_count", 0);
    RegisterVariable("bf_insert_steer_hold_time", 0);
    RegisterVariable("bf_insert_accel_count", 0);
    RegisterVariable("bf_insert_accel_hold_time", 0);
    RegisterVariable("bf_insert_brake_count", 0);
    RegisterVariable("bf_insert_brake_hold_time", 0);
    RegisterVariable("bf_delete_steer_enabled", false);
    RegisterVariable("bf_delete_steer_count", 0);
    RegisterVariable("bf_delete_accel_enabled", false);
    RegisterVariable("bf_delete_accel_count", 0);
    RegisterVariable("bf_delete_brake_enabled", false);
    RegisterVariable("bf_delete_brake_count", 0);
    PhysicsBridge::Start();
    ...
    instanceNonce = Math::Rand(0, 2147483647);
    instanceUid = Text::FormatUInt(instancePid) + "-" + Text::FormatUInt(instanceNonce);
